                ...
                <div class="carousel-image-container">
                    ...
                    <div class="carousel-overlay">
                        <div class="container reveal"> {{-- Tambahkan reveal di sini --}}
                            ...
                            <p class="animate__animated animate__fadeInUp">Jendela dunia bagi para santri. Akses literasi
                                dan kitab kuning dalam satu genggaman untuk mewujudkan generasi yang kaya amal dan anggun
                                dalam akhlak.</p>
                        </div>
                    </div>
                </div>
