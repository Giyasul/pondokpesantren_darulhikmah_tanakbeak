...
@section('konten')
    ...
    <style>
        ...
        .carousel-overlay h1 {
            transition-delay: 0.3s; /* Jeda sedikit agar estetik */
        }
        ...
        /* 5. Main Wrapper */
        .main-gallery-wrapper { margin-top: 60px; padding-bottom: 100px; }
        ...
        .video-card:hover { transform: translateY(-8px); box-shadow: 0 12px 25px rgba(0, 0, 0, 0.1); }
        ...
        .video-title { font-weight: 700; color: #333; margin: 0; font-size: 1.1rem; }
