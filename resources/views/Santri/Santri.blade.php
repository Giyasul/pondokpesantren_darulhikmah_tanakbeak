...
<style>
    ...
    html, body { background-color: var(--light-bg); overflow-x: hidden; }
    ...
    .main-content-wrapper {
        background: #ffffff; border-radius: 20px; padding: 50px 40px;
        box-shadow: 0 10px 30px rgba(0, 0, 0, 0.05); border: 1px solid #eee;
        margin-top: 40px; position: relative; z-index: 5;
    }

    .section-title {
        color: var(--primary-green); font-weight: 800; text-transform: uppercase;
        display: inline-block; position: relative; padding-bottom: 15px; font-size: 1.75rem;
    }
    .section-title::after {
            ...
            <div class="col-lg-4 text-end">
                <form action="{{ route('santri.index') }}" method="GET">
                    ...
                    <div class="input-group">
                        <input type="text" name="search" class="form-control border-success" placeholder="Cari..." value="{{ request('search') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <span class="badge {{ $st == 'aktif' ? 'bg-success' : 'bg-secondary' }} px-3 text-capitalize">
                                {{ $st }}
                            </span>
                        </td>
                        <td class="text-center">
                            <button class="btn btn-sm btn-outline-success px-3 fw-bold" data-bs-toggle="modal" data-bs-target="#detailModal{{ $s->id }}">
                                DETAIL
                            </button>
                        </td>
                    </tr>
